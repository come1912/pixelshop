...
<div id="Layout">
  ...
  <div id="Top">
    <div id="Logo">
      <h1><img src="images/files/logo.png" width="130" height="100" longdesc="index.html" /></h1>
    </div>
    <!-- end div #Logo -->
    <div id="TopContent">
      <ul>
    ...
    <img src="images/user-icon.png" width="17" height="20" longdesc="index.jsp" />
    <!-- end div #TopContent -->
    <div id="Nav">
      <div class="NavBody">
        <ul>
  ...
  <div id="Content">
      ...
      <div class="leftBox">
        ...
        <div class="leftBoxBody">
          <ul class="cat-link">
            ...
            <li><a href="ProduitObjectif">Objectifs</a></li>
            <li>Accessoires</li>
            <li>Nettoyage</li>
       ...
       <div class="leftBox">
        <ul>
       <form name="login-form" class="login-form" action="LoginServlet" method="GET">
    ...
    <a href="indexA.jsp"><img src="images/admin-icon.png" alt="admin" /></a>
